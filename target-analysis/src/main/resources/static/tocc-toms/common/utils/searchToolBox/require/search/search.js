...
define(['../utils/searchUtils',
    ...
    searchres.event=function(){
        ...
        //    var tab = {
        //        title: "公交站",
        //        content: ctx+"/control/map-search/page/station/station.html?layerName=SP_GJZD2&key=",
        //        contentType:"iframe",
        //        data:{
        //            name:"SP_GJZD2"
        //        }
        ...
        $(".enters-ico-1").click(function(){
            var tab = {
                title: "公交站",
                content: ctx+"/control/map-search/page/poi/poiSearch.html?layername=SP_GJZD&key=",
                contentType:"iframe",
                data:{
                    name:"SP_GJZD"
                }
        ...
        $(".enters-ico-2").click(function(){
            var tab = {
                title: "公交路线",
                content: ctx+"/control/map-search/page/poi/poiSearch.html?layername=SL_GJLX&key=",
                contentType:"iframe",
                data:{
                    name:"SL_GJLX"
                }
