...
var poiConfig = {
    ...
    "SP_ZXCTKD": {
        "config": {"layerName": "S_SP_ZXCTKD", "label": "自行车停靠点站", "icon": "", "locateIcon": "/control/map-search/resource/images/ZXCTKD.png","offsetX":0,"offsetY":17,"class":"jt-uniE629"},
        "title": "MC",
    ...
    "SP_ZXCTKD": {
        "config": {"layerName": "S_SP_ZXCTKD", "label": "自行车站点数据", "icon": "", "locateIcon": "/control/map-search/resource/images/ZXCTKD.png","offsetX":0,"offsetY":17,"class":"jt-uniE629"},
        "title": "MC",
    ...
    "SL_GJLX": {
        "config": {"layerName": "SL_GJLX", "label": "公交路线", "icon": "", "locateIcon": "/control/map-search/resource/images/GJZ_1.png","offsetX":0,"offsetY":17,"class":"jt-uniE629"},
        "title": "MC",
        "list": "X,Y,ID,MC,BM,SCODE,XCODE,PCODE",
        "data": {
            "MC": {"label": "名称"},
