// define([
//      'text!./tpl/boxTpl.html',
// ],function(boxTpl){
//     // 模板生成方法（从baseview中拷出来，this指向windows）
//     window.$tplNames = []
//     function _templateFn(baseTpl){
//         var _self = window,
//             tplObj = {};
...
//             })
//         }
//         tplObj && _addTplMethod(tplObj);
//     }
//     function _addTplMethod(tplObj){
//        for(var key in tplObj) {
//             var funcName = _fmtTplName(key);
//             funcName = funcName + "Template";
//             window[funcName] = _.template(tplObj[key]);
//             window.$tplNames.push(funcName);
//         }
...
//     // 功能实现
//     var searchListBox = {};
//     searchListBox.creatBox = function() {
//        console.log(window.textInfoTemplate({test:"11111"}))
//     }
...
define([
    ...
    './require/config/poiconfig',
    'text!./tpl/mapSearchTemplate.html',
    './require/utils/searchUtils',
    './require/utils/routesUtils',
    '../../BaseView',
    'bmap',
    'map_utils',
    'css!./res/css/mapSearch.css'
],function($, Remind, Search, PoiConfig, MapSearchTemplate, searchUtils, RoutesUtils, BaseView, bmap,mapUtils){
     var that;
    ...
    var view = BaseView.extend({
        ...
        initUI:function(){
            ...
            $(".panel-bottom-ico").on("click",function (){
                $(".search-result").hide();
            });
        },
