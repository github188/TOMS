package com.linkcld.toms.common.utils.excel.utils;

import com.linkcld.toms.common.utils.excel.bean.ExcelColBean;
import com.linkcld.toms.common.utils.excel.exception.ImportExcelException;
import com.linkcld.toms.common.utils.excel.utils.anno.ExcelSupport;
    ...
    public static Object getValueType(String value, Type type) {
        ...
        try {
            if (type == String.class) {
                return value;
            } else if (type == Integer.class && !"".equals(value)) {
                return Integer.parseInt(value);
            } else if (type == Short.class && !"".equals(value)) {
                return Short.parseShort(value);
            } else if (type == Long.class && !"".equals(value)) {
                return Long.parseLong(value);
            } else if (type == Double.class && !"".equals(value)) {
                return Double.parseDouble(value);
            } else if (type == Float.class && !"".equals(value)) {
            ...
            for (int rowNum = 0; rowNum <= hssfSheet.getLastRowNum(); rowNum++) {
                ...
                try {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        throw new ImportExcelException(rowNum + "行,字段:" + method + "的值："+ value +"有误");
                    }
                    beans.add(bean);
